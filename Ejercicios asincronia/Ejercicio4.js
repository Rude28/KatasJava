...
const adults2 = ages2.filter(age => age % 2 === 0);
...
const morePlayed = streamers.filter(streamer => streamer.gameMorePlayed === 'League of Legends');
...
const leagueStreamers = streamers3.filter(streamer => streamer.gameMorePlayed.includes('Legends')).map(streamer =>{
    if(streamer.age > 35){
        return {
            ...streamer,
